...
(function() {
  var BackgroundContainer, CircleActor, GameModes, GameSceneActor, LevelContainer, LevelEvents, LevelModel, ObservableModel, PlayerActor, PlayerEvents, PlayerModel, RingActor, RingModel, namespace,
    __slice = [].slice,
