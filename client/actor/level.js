...
(function() {
    ...
    FNT.LevelContainer.prototype = {
        ...
        create : function(scene, gameModel) {
            this.scene = scene;
        ...
        handleEvent : function(event) {
            if ( event.source == FNT.EventSources.LEVEL ) {
                if ( event.event == FNT.LevelEvents.LOAD) {
        ...
        loadLevel : function(level) {
            ...
            // CREATE ALL RINGS
            for (i = 0; i < level.getRings().length; i++) {
                ring = level.getRings()[i];
                ...
                this.addChild(ringActor);  // Add it to the scene graph
            }
